...
from cashcar.training_and_serving import my_config
from cashcar.training_and_serving.preprocessing import preprocess_data
...
def load_data():
    data = pd.read_csv(my_config.DATA_PATH,
                       index_col = 'index')
    return data
...
def generate_features(data):
    ...
    data["model_years_old"] = datetime.datetime.today().year - data['prod_date']
    data.drop("prod_date", axis=1, inplace=True)
