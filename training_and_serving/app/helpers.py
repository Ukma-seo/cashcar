...
from cashcar.training_and_serving import my_config, my_utils, preprocessing
from cashcar.training_and_serving.app.settings import MODELS_SUPPORTED
from cashcar.training_and_serving.dnn import PriceRegressorDNN
...
def predict(model, features_dict):
    ...
    features_df = pd.DataFrame.from_records(features_dict, index=[0])
